...
RUN dotnet restore "./Architecture-Model/Architecture-Model.csproj"

# Compile, then pack the compiled app and dependencies into a deployable unit.
# https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-publish?tabs=netcore21
RUN dotnet publish "./Architecture-Model/Architecture-Model.csproj" -c Release -o /app/publish
...
# To run the app, run `dotnet DockerWithReact.dll`, which we just copied over.
ENTRYPOINT ["dotnet", "Architecture-Model.dll"]